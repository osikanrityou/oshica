...
export function BottomNav() {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-50 px-4 pb-4">
      <div className="mx-auto max-w-md rounded-[2rem] border border-oshica-border/70 bg-white/90 px-3 py-2 shadow-[0_10px_40px_rgba(44,56,85,0.14)] backdrop-blur-xl">
...
function NavItem({
  ...
  return (
    <Link
      href={item.href}
      className={cn(
        "mx-auto flex min-w-[64px] flex-col items-center justify-center gap-1 rounded-2xl px-1 py-2 text-[11px] font-bold transition",
        active
